...
def update_csv_files(trn_config_name, data_frames):
    """
...
if __name__ == "__main__":
    ...
    for epoch in range(start_epoch, end_epoch + 1):
        ...
        updated_dfs = correct_val_labels(logger, cor_config, trn_config_name, epoch, predicted_label_history)
        update_csv_files(trn_config_name, updated_dfs)
